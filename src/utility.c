...
int wavCheck(gpointer tmp){
    ...
    while(ok){
        if(data[i] == 0x52 && data[i + 1] == 0x49 && data[i + 2] == 0x46 && data[i + 3] == 0x46) break;//seek "RIFF"
        else {
            i++;
            if(i > 1){
                ok = 0;
    ...
    while(ok){
        if(data[i] == 0x57 && data[i + 1] == 0x41 && data[i + 2] == 0x56 && data[i + 3] == 0x45) break;//seek "WAVE"
        else {
            i++;
            if(i > 8){
                ok = 0;
    ...
    while(ok){
        if(data[i] == 0x10 && data[i + 1] == 0x00 && data[i + 2] == 0x00 && data[i + 3] == 0x00) break;//seek "0x10000000" = 16
        else {
            i++;
            if(i > 16){
                ok = 0;
    ...
    if(ok){
        ...
        if(setting == 2) da->settings.channels = setting;
        else ok = 1;//0;
    } 
    if(ok){
    ...
    while(ok){
        if(data[i] == 0x64 && data[i + 1] == 0x61 && data[i + 2] == 0x74 && data[i + 3] == 0x61) break;//seek "data"
        else {
            i++;
            if(i > 196) ok = 0;
        }
